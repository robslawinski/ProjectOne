...
include_once ('PeopleAdapter.php');
...
echo "BEGIN TESTING FACTORY, DECORATOR, ADAPTER, AND STRATEGY METHOD PATTERN";
...
function TestFactory($factoryMethodInstance) 
{
	...
	//
	$personAdapter = new PeopleAdapter($test);
	echo 'Full Name Using Adapter: ' . $personAdapter->getFullName() . tagging("br");
